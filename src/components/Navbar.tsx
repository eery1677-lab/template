...
export function Navbar({ entranceComplete, onSubmitClick }: NavbarProps) {
        ...
        <div className="hidden sm:flex items-center justify-between w-full">
              ...
              <AnimatePresence>
                {menuOpen && (
                  ...
                  >
                    ...
                    >
                      <ScrambleText text="Browse" isHovered={aboutHovered} />
                    </button>
                    <button
                      className="text-[16px] font-normal text-white/85 hover:text-white transition-colors cursor-pointer bg-transparent border-none"
                    ...
                    >
                      <ScrambleText text="Stats" isHovered={metricsHovered} />
                    </button>
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              className="h-12 px-6 bg-white rounded-full flex items-center gap-2 cursor-pointer border-none"
              whileHover={{ scale: 1.03, backgroundColor: '#e2e2e6' }}
              whileTap={{ scale: 0.97 }}
              onMouseEnter={() => setDownloadHovered(true)}
              onMouseLeave={() => setDownloadHovered(false)}
            >
              <i className="bi bi-plus-lg text-black text-[16px]" />
              <span className="text-black text-[16px] font-medium">
                <ScrambleText text="Submit Tool" isHovered={downloadHovered} />
              </span>
            </motion.button>
          </div>
        </div>
        ...
        <div className="flex sm:hidden items-center justify-between w-full">
          ...
          <div className="flex items-center gap-1.5 ml-2">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <i className="bi bi-plus-lg text-black text-[13px]" />
              <span className="text-black text-[13px] font-medium">Submit</span>
            </motion.button>
          </div>
        </div>
      </motion.nav>
